...
0129: $VAN1_DRIVER = create_actor 12 #GANG11 in_car $CAR_VAN1_LM4 driverseat 
...
01B2: give_actor $GOON_IN_HANGAR1 weapon WEAPONTYPE_CHAINGUN ammo 9999 
01B2: give_actor $GOON_IN_HANGAR2 weapon WEAPONTYPE_UZI ammo 9999 
...
while true
	...
	then
		...
		then
			...
			01B2: give_actor $GOON_IN_HANGAR3 weapon WEAPONTYPE_CHAINGUN ammo 9999 
			0004: $GOON_IN_HANGAR3_FLAG = 1 
		end
		if
...
0164: disable_marker $LOVE_4_BLIP 
0054: get_player_coordinates $PLAYER_CHAR store_to $PLAYER_LO4_X $PLAYER_LO4_Y $PLAYER_LO4_Z 

0086: $DIFFER_X = $PLAYER_LO4_X 
0061: $DIFFER_X -= $RESULT1_X 
0086: $DIFFER_Y = $PLAYER_LO4_Y 
...
01B2: give_actor $GOON_AT_YARD3 weapon WEAPONTYPE_CHAINGUN ammo 9999 
...
01B2: give_actor $GOON_AT_YARD4 weapon WEAPONTYPE_CHAINGUN ammo 9999 
...
01B2: give_actor $GOON_AT_YARD5 weapon WEAPONTYPE_CHAINGUN ammo 9999 
...
01B2: give_actor $GOON_AT_YARD6 weapon WEAPONTYPE_CHAINGUN ammo 9999 
...
01B2: give_actor $GOON_AT_YARD7 weapon WEAPONTYPE_CHAINGUN ammo 9999 
...
01B2: give_actor $GOON_AT_YARD8 weapon WEAPONTYPE_CHAINGUN ammo 9999 
...
01B2: give_actor $GOON_AT_YARD10 weapon WEAPONTYPE_CHAINGUN ammo 9999 
...
if and
	8119:   not car $COLOMBIAN_CAR wrecked
	8118:   not actor $YAKUZA_GUARD5 dead 
then
	0224: set_car $COLOMBIAN_CAR health_to 2500 
	01D9: actor $YAKUZA_GUARD5 destroy_car $COLOMBIAN_CAR
end
...
01C3: remove_references_to_car $COLOMBIAN_CAR 
...
004F: create_thread @LOVE_MISSION5_LOOP  
goto @MISSION_END_LOVE4
...
then
	...
	then
		...
		01B2: give_actor $GOON_AT_YARD2 weapon WEAPONTYPE_CHAINGUN ammo 9999 
		0350: set_actor $GOON_AT_YARD2 maintain_position_when_attacked 1
		if
			00E0:   is_player_in_any_car $PLAYER_CHAR 
		then
