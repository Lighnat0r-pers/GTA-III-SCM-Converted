...
009A: $FBI4 = create_char PEDTYPE_CIVMALE model #GANG01 at 48.375 -642.75 29.0 //Park
0173: set_actor $FBI4 z_angle_to 169.0 
...
009A: $FBI7 = create_char PEDTYPE_CIVMALE model #GANG02 at 42.1875 -641.25 27.75 //Park
0173: set_actor $FBI7 z_angle_to 208.0 
...
while 8038:   not  $NUMBER_OF_FEDS_KILLED == 10 
	wait 0 ms
	if and
	...
	then
		if and
			8185:   not car $FBI_VAN1 health >= 999 
...
004F: create_thread @KENJI_MISSION1_LOOP 
goto @MISSION_END_ASUKA2
