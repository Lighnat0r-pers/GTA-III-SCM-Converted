...
while 001A:   10 > $CLUBBERS_FLEE_FLAG
	...
	then
		...
		then
			...
			gosub @CHECK_CREATE_NEXT_PARTY_PERSON_FRANKIE1
			0084: $FRANK1_PARTY_PERSON8 = $FRANK1_PARTY_PERSON_TEMP
			0004: $CLUBBERS_FLEE_FLAG = 8 
			0004: $CLUBBER8_CAR3 = 1
		else
			if
	...
	then
		if
			0118:   actor $FRANK1_PARTY_PERSON8 dead 
		then
			01C2: remove_references_to_actor $FRANK1_PARTY_PERSON8
			gosub @CREATE_MARIA_AFTER_PARTY_FRANKIE1
		else
			if
				80EC:   not actor $FRANK1_PARTY_PERSON8 0 $INSIDE_WAREHOUSE_X $INSIDE_WAREHOUSE_Y radius 2.0 2.0
			then
				gosub @CREATE_MARIA_AFTER_PARTY_FRANKIE1
			end
		end
...
if
	0038:   $FLAG_LUIGI_MISSION4_TERMINATED == 1
then
	004F: create_thread @LUIGI_MISSION4_LOOP 
...
if
	0038:   $FLAG_LUIGI_MISSION5_TERMINATED == 1
then
	004F: create_thread @LUIGI_MISSION5_LOOP 
	0164: disable_marker $LUIGI_MISSION_MARKER 
	02A7: $LUIGI_MISSION_MARKER = create_icon_marker_and_sphere RADAR_SPRITE_LUIGI at 886.1875 -417.0625 -100.0
end
if
	0038:   $FLAG_JOEY_MISSION5_TERMINATED == 1
then
	004F: create_thread @JOEY_MISSION5_LOOP 
...
if
	0038:   $FLAG_JOEY_MISSION6_TERMINATED == 1
then
	004F: create_thread @JOEY_MISSION6_LOOP 
	0164: disable_marker $JOEY_MISSION_MARKER 
	02A7: $JOEY_MISSION_MARKER = create_icon_marker_and_sphere RADAR_SPRITE_JOEY at 1191.688 -870.0 -100.0
end
...
004F: create_thread @IMP_EXP_PAGER 
goto @MISSION_END_FRANKIE1
...
then
	0084: $CLUBBER_CAR_TEMP = $CLUBBER3_CAR1
	0084: $FRANK1_PARTY_PERSON_TEMP = $FRANK1_PARTY_PERSON8
				...
				then
					...
					then
						...
						if
							8118:   not actor $FRANK1_PARTY_PERSON7 dead
						then
							01C9: actor $FRANK1_SWAT_TEMP kill_actor $FRANK1_PARTY_PERSON7
						else
