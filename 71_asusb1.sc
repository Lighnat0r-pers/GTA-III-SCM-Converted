...
while 001A:   12 > $COUNTER_CARTELS_KILLED_AS1 
	wait 0 ms
	...
	if
		001C:   $COUNTER_BAILOUTS > $COUNTER_ASUKAS_REVENGE
	then
		00BC: print_now 'AS1_H' duration 3000 ms flag 1  // ~r~You failed to lead the Deathsquad into the Yakuza trap!!
	...
	then
		...
		0084: $PASSENGER_1_TEMP_WEAPON = WEAPONTYPE_M16
		0084: $PASSENGER_1_TEMP_AMMO = 100
		0084: $PASSENGER_2_TEMP = $CARTEL2_AS1
		0084: $PASSENGER_2_TEMP_WEAPON = WEAPONTYPE_M16
		0084: $PASSENGER_2_TEMP_AMMO = 100
		0084: $PASSENGER_3_TEMP = $CARTEL3_AS1
		0084: $PASSENGER_3_TEMP_WEAPON = WEAPONTYPE_SHOTGUN
		0084: $PASSENGER_3_TEMP_AMMO = 15
		0084: $PASSENGER_4_TEMP = $CARTEL4_AS1
		0084: $PASSENGER_4_TEMP_WEAPON = WEAPONTYPE_SHOTGUN
		0084: $PASSENGER_4_TEMP_AMMO = 15
	...
	then
		...
		0084: $PASSENGER_1_TEMP_WEAPON = WEAPONTYPE_UZI
		0084: $PASSENGER_1_TEMP_AMMO = 90
		0084: $PASSENGER_2_TEMP = $CARTEL6_AS1
		0084: $PASSENGER_2_TEMP_WEAPON = WEAPONTYPE_UZI
		0084: $PASSENGER_2_TEMP_AMMO = 90
		0084: $PASSENGER_3_TEMP = $CARTEL7_AS1
		0084: $PASSENGER_3_TEMP_WEAPON = WEAPONTYPE_UZI
		0084: $PASSENGER_3_TEMP_AMMO = 90
		0084: $PASSENGER_4_TEMP = $CARTEL8_AS1
		0084: $PASSENGER_4_TEMP_WEAPON = WEAPONTYPE_M16
		0084: $PASSENGER_4_TEMP_AMMO = 100
...
then
	...
	0084: $PASSENGER_CURRENT_AMMO = $PASSENGER_1_TEMP_AMMO
	...
	0084: $PASSENGER_CURRENT_AMMO = $PASSENGER_2_TEMP_AMMO
	gosub @GET_PASSENGER_OUT_CAR
	...
	0084: $PASSENGER_CURRENT_AMMO = $PASSENGER_3_TEMP_AMMO
	gosub @GET_PASSENGER_OUT_CAR
	...
	0084: $PASSENGER_CURRENT_AMMO = $PASSENGER_4_TEMP_AMMO
	gosub @GET_PASSENGER_OUT_CAR
...
then
	...
	01B2: give_actor $PASSENGER_CURRENT weapon $PASSENGER_CURRENT_WEAPON ammo $PASSENGER_CURRENT_AMMO 
