...
01E1: set_actor $FRANK3_CARTEL3 follow_route 0 behaviour 3 
...
01E1: set_actor $FRANK3_CARTEL4 follow_route 1 behaviour 3 
...
01E1: set_actor $FRANK3_CARTEL5 follow_route 2 behaviour 3 
...
01E1: set_actor $FRANK3_CARTEL6 follow_route 3 behaviour 3 
...
01E1: set_actor $FRANK3_CARTEL7 follow_route 4 behaviour 3 
...
01E1: set_actor $FRANK3_CARTEL8 follow_route 5 behaviour 3 
...
01E1: set_actor $FRANK3_CARTEL10 follow_route 6 behaviour 3 
...
while 8038:   not  $FLAG_BLOKE_IN_AREA_FM3 == 13 
	...
	then
		...
		if and
			...
			03D2:   wav_ended
		then
			03D5: remove_text 'FM3_8I'  // ~w~Get a good vantage point then I'll head in when you fire the first shot.
		end
		if
		...
		then
			...
			if or
				0018:   $COUNTER_GUARDS_DEAD_FM3 > 0 
				02D5:   player $PLAYER_CHAR firing_weapons_in_rectangle 1610.563 -614.5625 1340.875 -1074.5 0 
			then
				0006: 17@ = 0
				while 001B:   5000 > 17@ 
					wait 0 ms
...
004F: create_thread @EMERGENCY_CRANE_PAGER 
goto @MISSION_END_FRANK3
