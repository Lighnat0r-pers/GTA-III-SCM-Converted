...
while 80E3:   not player $PLAYER_CHAR 1 $WH_X_RM2 $WH_Y_RM2 radius 4.0 4.0 
	...
	then
		...
		020A: set_car $PHIL_TRUCK_1 door_status_to CARLOCK_LOCKED 
...
01B2: give_actor $PHIL weapon WEAPONTYPE_M16 ammo 200 
...
0213: $PHILS_ROCKET = create_pickup #ROCKET type PICKUP_ONCE at $ROCKET_X $ROCKET_Y 14.5
