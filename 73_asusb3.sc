...
while true
	...
	0164: disable_marker $BLIP_AS3_DODO 
	...
	0167: $BLIP_AS3_DODO = create_marker_at $DODO_AS3_X $DODO_AS3_Y $DODO_AS3_Z color 4 visibility BLIP_ONLY 
	0168: show_on_radar $BLIP_AS3_DODO 3 
...
then
	...
	then
		...
		if
			0038:   $CURRENT_LOOP_AS3 == 1
		then
			0168: show_on_radar $BLIP_AS3_DODO 2
		else
			0168: show_on_radar $BLIP_AS3_DODO 3
		end
	end
...
then
	...
	01B2: give_actor $KAPPA_CARTEL10 weapon WEAPONTYPE_ROCKET ammo 5 
	035F: set_actor $KAPPA_CARTEL10 armour_to 100 
