...
0004: $ONMISSION = 1
if 
	0038:   $MAFIA_MASSACRE_COMPLETED == 0 
then
	0317: increment_mission_attempts
end
00BA: print_big 'RC2' time 15000 style 2  // 'MAFIA MASSACRE'
0001: wait 0 ms 
0004: $COUNTER_RC = 0 
...
0152: set_zone_car_info 'LITTLEI' DAY 10 250 0 0 0 0 0 0 20 400 0 0 250 50 0 
0152: set_zone_car_info 'LITTLEI' NIGHT 8 250 0 0 0 0 0 0 10 550 0 0 150 0 0 
...
then
	...
	0158: camera_on_vehicle $RC_VAN 15 switchstyle JUMP_CUT
	0395: clear_area 1 at $RC_X $RC_Y range $RC_Z 5.0 
end
00BC: print_now 'RC_2' time 4000 flag 1  // You have 2 minutes to blow up as many Mafia Gang Cars as possible!
...
while 801A:   NOT   1 > $COUNTDOWN_TIME1 
	...
	0298: $COUNTER_RC = rampage_kills #MAFIA 
	if
		0018:   $INTRO_TIME_LAPSED > 4000 
	then
		if
...
if
	001C:   $COUNTER_RC > $RC2_RECORD
then
	0084: $REWARD_RC = $COUNTER_RC 
	0060: $REWARD_RC -= $RC2_RECORD 
	0010: $REWARD_RC *= 1000 
	0084: $RC2_RECORD = $COUNTER_RC
...
then
	...
	0004: $MAFIA_MASSACRE_COMPLETED = 1 
	0318: set_latest_mission_passed 'RC2'  // 'MAFIA MASSACRE'
end
042F: save_record 2 $RC2_RECORD 
return 
...
0152: set_zone_car_info 'LITTLEI' DAY 10 100 0 0 0 0 0 0 20 400 0 0 350 50 0 
