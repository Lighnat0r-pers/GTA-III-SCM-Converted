...
0004: $BLOB_FLAG = 1 
0004: $FLAG_HAD_BUS_MESSAGE_LM3 = 0 
...
03E5: text_box 'LM3_1A'  // Press the~h~ ~k~~VEHICLE_HORN~ button~w~ to activate the ~h~horn~w~ and let Misty know you are here.
...
004F: create_thread @MEAT_MISSION1_LOOP 
return
