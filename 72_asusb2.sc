...
while 001A:   9 > $COUNTER_KAPPA_DEAD 
	...
	0005: $CARTEL_RUN_TARGET_X = 1335.5
	0005: $CARTEL_RUN_TARGET_Y = -820.5 
	...
	0005: $CARTEL_RUN_TARGET_X = 1342.7
	0005: $CARTEL_RUN_TARGET_Y = -259.0 
	gosub @KAPPA_DEATH_CHECK
	...
	0005: $CARTEL_RUN_TARGET_X = 280.0
	0005: $CARTEL_RUN_TARGET_Y = -676.5 
	gosub @KAPPA_DEATH_CHECK
	...
	0005: $CARTEL_RUN_TARGET_X = 34.5
	0005: $CARTEL_RUN_TARGET_Y = -850.0 
	gosub @KAPPA_DEATH_CHECK
	...
	0005: $CARTEL_RUN_TARGET_X = 13.7
	0005: $CARTEL_RUN_TARGET_Y = -1135.3
	gosub @KAPPA_DEATH_CHECK
	...
	0005: $CARTEL_RUN_TARGET_X = 79.0
	0005: $CARTEL_RUN_TARGET_Y = -1361.0 
	gosub @KAPPA_DEATH_CHECK
	...
	0005: $CARTEL_RUN_TARGET_X = 282.5
	0005: $CARTEL_RUN_TARGET_Y = -1501.0 
	gosub @KAPPA_DEATH_CHECK
	...
	0005: $CARTEL_RUN_TARGET_X = -638.8
	0005: $CARTEL_RUN_TARGET_Y = -721.6
	gosub @KAPPA_DEATH_CHECK
	...
	0005: $CARTEL_RUN_TARGET_X = -1251.0
	0005: $CARTEL_RUN_TARGET_Y = -114.5
	gosub @KAPPA_DEATH_CHECK
...
then
	...
	then
		...
		then
			...
			0239: actor $KAPPA_CARTEL_TEMP run_to $CARTEL_RUN_TARGET_X $CARTEL_RUN_TARGET_Y
		end
	end
	if
		8118:   not actor $KAPPA_CARTEL_TEMP dead
