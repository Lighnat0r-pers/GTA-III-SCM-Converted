			...
			then
				...
				then
					if
						0038: $ONMISSION == 0
					then
						while 834D:   not unknown_rotate_object $PORTLAND_HIDEOUT_DOOR unknown_angle 210.0 10.0 0
							wait 0 ms
						end
					else
						while 834D:   not unknown_rotate_object $PORTLAND_HIDEOUT_DOOR unknown_angle 0.0 10.0 0
							wait 0 ms
						end
					end
				end
				...
				then
					...
					then
						...
						03D1: play_wav
						while 834D:   not unknown_rotate_object $PORTLAND_HIDEOUT_DOOR unknown_angle 0.0 8.0 0 
							wait 0 ms
						end
						...
						then
							...
							03C8: rotate_player_180_degrees
						end
						wait 1000 ms
						if
							0256:   player $PLAYER_CHAR defined
		...
		then
			...
			then
				if
					0038: $ONMISSION == 0
				then
					while 834D:   not unknown_rotate_object $SSV_HIDEOUT_DOOR unknown_angle 250.0 10.0 0 
						wait 0 ms
					end
				else
					while 834D:   not unknown_rotate_object $SSV_HIDEOUT_DOOR unknown_angle 180.0 10.0 0
						wait 0 ms
					end
				end
				if and
				...
				then
					...
					then
						...
						while 834D:   not unknown_rotate_object $SSV_HIDEOUT_DOOR unknown_angle 180.0 8.0 0
							wait 0 ms
						end
						03D8: show_save_screen
						wait 0 ms
