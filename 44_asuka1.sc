...
while 801A:   not  1 > $ASUKA1_MINS_TO_SALVATORE_LEAVES 
	wait 0 ms
	00C1: $ASUKA1_MINS_TO_SALVATORE_LEAVES = get_minutes_until_time_of_day $ASUKA1_SALVATORE_LEAVING_TIME_HOURS $ASUKA1_SALVATORE_LEAVING_TIME_MINS
...
if
	8056:   not is_player_in_area_2d $PLAYER_CHAR coords 873.0 -443.0 927.0 -378.0 sphere 0
then
	...
	0395: clear_area 0 at 905.75 -419.9375 range 8.0 8.0 
	0247: request_model #INDHIBUILD3 
	0247: request_model #LUIGICLUBOUT 
	0247: request_model #LUIGIINEERCLUB 
	0247: request_model #IND_CUSTOMROAD016 
	038B: load_all_models_now 
	03AF: set_streaming 0 
	015F: set_camera_position 881.3125 -425.1875 19.6875 0.0 rotation 0.0 0.0 
	0160: point_camera 882.0625 -424.8125 19.125 switchstyle JUMP_CUT
	0006: 17@ = 0 
	0004: $BEAMER1_HEALTH = 1
end
...
while true
	...
	then
		...
		if and
			...
			80E1:   not is_button_pressed PAD1 button START
		then
			0004: $SKIP_FLAG = 1
		end
		if
		...
		then
			if or
				...
				00E1:   is_button_pressed PAD1 button START
			then
				02A3: toggle_widescreen 0 
				01B4: set_player $PLAYER_CHAR controllable 1 
				03BF: set_player $PLAYER_CHAR ignored_by_everyone_to 0 
	...
	0084: $MAFIA_CURRENT_X = $MAFIA_9_X
	0084: $MAFIA_CURRENT_y = $MAFIA_9_Y
	0004: $MAFIA_WEAPONA_ASUKA1 = WEAPONTYPE_UZI
	0004: $MAFIA_WEAPONB_ASUKA1 = WEAPONTYPE_UZI
	0004: $CHECK_BEAMER_FLAG_ASUKA1 = 1
	0004: $MAFIA_MODEL_ASUKA1 = #GANG01
	0004: $MAFIA_MODEL_FLAG_ASUKA1 = 0
	...
	0084: $MAFIA_CURRENT_X = $MAFIA_10_X
	0084: $MAFIA_CURRENT_y = $MAFIA_10_Y
	0004: $MAFIA_WEAPONA_ASUKA1 = WEAPONTYPE_SHOTGUN
	0004: $MAFIA_WEAPONB_ASUKA1 = WEAPONTYPE_UZI
	0004: $CHECK_BEAMER_FLAG_ASUKA1 = 0
	0004: $MAFIA_MODEL_FLAG_ASUKA1 = 0
	0004: $MAFIA_MODEL_ASUKA1 = #GANG01
	gosub @CREATE_MAFIA_ASUKA1
	...
	0084: $MAFIA_CURRENT_X = $MAFIA_11_X
	0084: $MAFIA_CURRENT_y = $MAFIA_11_Y
	0004: $MAFIA_WEAPONA_ASUKA1 = WEAPONTYPE_SHOTGUN
	0004: $MAFIA_WEAPONB_ASUKA1 = WEAPONTYPE_SHOTGUN
	0004: $CHECK_BEAMER_FLAG_ASUKA1 = 0
	0004: $MAFIA_MODEL_ASUKA1 = #GANG02
	0004: $MAFIA_MODEL_FLAG_ASUKA1 = 1
	gosub @CREATE_MAFIA_ASUKA1
	...
	0084: $MAFIA_CURRENT_X = $MAFIA_12_X
	0084: $MAFIA_CURRENT_y = $MAFIA_12_Y
	0004: $MAFIA_WEAPONA_ASUKA1 = WEAPONTYPE_UZI
	0004: $MAFIA_WEAPONB_ASUKA1 = WEAPONTYPE_SHOTGUN
	0004: $CHECK_BEAMER_FLAG_ASUKA1 = 0
	0004: $MAFIA_MODEL_ASUKA1 = #GANG01
	...
	0084: $MAFIA_CURRENT_X = $MAFIA_13_X
	0084: $MAFIA_CURRENT_y = $MAFIA_13_Y
	0004: $MAFIA_WEAPONA_ASUKA1 = WEAPONTYPE_SHOTGUN
	0004: $MAFIA_WEAPONB_ASUKA1 = WEAPONTYPE_SHOTGUN
	0004: $CHECK_BEAMER_FLAG_ASUKA1 = 2
	0004: $MAFIA_MODEL_ASUKA1 = #GANG02
	0004: $MAFIA_MODEL_FLAG_ASUKA1 = 1
	gosub @CREATE_MAFIA_ASUKA1
	...
	then
		...
		then
			if
				0038:   $KILL_PLAYER_NOW_FLAG == 0 
			then
				0211: actor $SALVATORE walk_to $STREET_X $STREET_Y 
			else
				0239: actor $SALVATORE run_to $STREET_X $STREET_Y 
			end
			0004: $FRANKIE_FLAG = 5 
...
then
	...
	if
		0038:   $KILL_PLAYER_NOW_FLAG == 0 
	then
		00AD: set_car_cruise_speed $ASUKA1_MAFIA_CAR1 to 18.0 
	else
		00AD: set_car_cruise_speed $ASUKA1_MAFIA_CAR1 to 43.0 
	end
end
...
then
	...
	if
		0038:   $KILL_PLAYER_NOW_FLAG == 0 
	then
		00AD: set_car_cruise_speed $ASUKA1_MAFIA_CAR2 to 17.0 
	else
		00AD: set_car_cruise_speed $ASUKA1_MAFIA_CAR2 to 42.0 
	end
end
...
then
	...
	if
		0038:   $KILL_PLAYER_NOW_FLAG == 0 
	then
		00AD: set_car_cruise_speed $ASUKA1_MAFIA_CAR3 to 16.0 
	else
		00AD: set_car_cruise_speed $ASUKA1_MAFIA_CAR3 to 41.0 
	end
end
...
then
	035F: set_actor $SALVATORE armour_to 100 
end
...
then
	...
	then
		...
		then
			0004: $DUMMY_VAR_ASUKA1 = 2
			if
				0038:   $MAFIA_MODEL_FLAG_ASUKA1 == 1
			then
				0004: $MAFIA_MODEL_ASUKA1 = #GANG01
			end
		end
	...
	if
		0018:   $DUMMY_VAR_ASUKA1 > 0 // 1 or 2
	then
		009A: $MAFIA_CURRENT_ASUKA1 = create_char PEDTYPE_GANG_MAFIA model $MAFIA_MODEL_ASUKA1 at $CREATE_CHAR_IN_CLUB_X $CREATE_CHAR_IN_CLUB_Y $CREATE_CHAR_IN_CLUB_Z
		if and
		...
		if
			0038:   $DUMMY_VAR_ASUKA1 == 1
		then
			01B2: give_actor $MAFIA_CURRENT_ASUKA1 weapon $MAFIA_WEAPONA_ASUKA1 ammo 999
		else
			01B2: give_actor $MAFIA_CURRENT_ASUKA1 weapon $MAFIA_WEAPONB_ASUKA1 ammo 999
		end
...
then
	...
	then
		...
		then
			00AD: set_car_cruise_speed $ASUKA1_MAFIA_CAR_CURRENT to 51.0 
		end
		if and
		...
		then
			00AD: set_car_cruise_speed $ASUKA1_MAFIA_CAR_OTHER2 to 49.0 
			if
...
then
	...
	then
		...
		then
			...
			0239: actor $ASUKA1_MAFIA10 run_to 886.0 -414.0 // NEAR BOTTOM OF STEPS
			0004: $MAFIA_10_KILL_PLAYER_FLAG = 1 
		end
		if and
			0038:   $MAFIA_10_KILL_PLAYER_FLAG == 1 
			00ED:   actor $ASUKA1_MAFIA10 #NULL 886.0 -414.0 radius 1.0 1.0 // NEAR BOTTOM OF STEPS
		then
			0411: set_actor $ASUKA1_MAFIA10 use_pednode_seek 0 
			0239: actor $ASUKA1_MAFIA10 run_to 888.875 -409.8125 // AT BOTTOM OF STEPS
			0004: $MAFIA_10_KILL_PLAYER_FLAG = 2 
		end
		if and
			0038:   $MAFIA_10_KILL_PLAYER_FLAG == 2 
			00ED:   actor $ASUKA1_MAFIA10 #NULL 888.875 -409.8125 radius 1.0 1.0 // AT BOTTOM OF STEPS
		then
			0239: actor $ASUKA1_MAFIA10 run_to 880.9375 -409.0 // ON LANDING
			0004: $MAFIA_10_KILL_PLAYER_FLAG = 3 
		end
		if and
			0038:   $MAFIA_10_KILL_PLAYER_FLAG == 3
			00ED:   actor $ASUKA1_MAFIA10 #NULL 880.9375 -409.0 radius 1.0 1.0 // ON LANDING
		then
			0239: actor $ASUKA1_MAFIA10 run_to 880.9375 -406.0625 // ON LANDING
			0004: $MAFIA_10_KILL_PLAYER_FLAG = 4
		end
		if and
			0038:   $MAFIA_10_KILL_PLAYER_FLAG == 4
			00ED:   actor $ASUKA1_MAFIA10 #NULL 880.9375 -406.0625 radius 1.0 1.0 // ON LANDING
		then
			0239: actor $ASUKA1_MAFIA10 run_to 892.0625 -406.1875 // ON ROOF TOP OF STAIRS
			01B2: give_actor $ASUKA1_MAFIA10 weapon WEAPONTYPE_UZI ammo 9999 
			0004: $MAFIA_10_KILL_PLAYER_FLAG = 5
		end
		if and
			0038:   $MAFIA_10_KILL_PLAYER_FLAG == 5
			00ED:   actor $ASUKA1_MAFIA10 #NULL 892.0625 -406.1875 radius 1.0 1.0 // ON ROOF TOP OF STAIRS
		then
			0411: set_actor $ASUKA1_MAFIA10 use_pednode_seek 1 
			0350: set_actor $ASUKA1_MAFIA10 maintain_position_when_attacked 1 
			01CA: actor $ASUKA1_MAFIA10 kill_player $PLAYER_CHAR 
			0004: $MAFIA_10_KILL_PLAYER_FLAG = 6
		end
	end
	...
	then
		...
		then
			...
			0239: actor $ASUKA1_MAFIA11 run_to 886.0 -414.0 // NEAR BOTTOM OF STEPS
			0004: $MAFIA_11_KILL_PLAYER_FLAG = 1 
		end
		if and
			0038:   $MAFIA_11_KILL_PLAYER_FLAG == 1 
			00ED:   actor $ASUKA1_MAFIA11 #NULL 886.0 -414.0 radius 1.0 1.0 // NEAR BOTTOM OF STEPS
		then
			0411: set_actor $ASUKA1_MAFIA11 use_pednode_seek 0 
			0239: actor $ASUKA1_MAFIA11 run_to 888.875 -409.8125 // AT BOTTOM OF STEPS
			0004: $MAFIA_11_KILL_PLAYER_FLAG = 2 
		end
		if and
			0038:   $MAFIA_11_KILL_PLAYER_FLAG == 2 
			00ED:   actor $ASUKA1_MAFIA11 #NULL 888.875 -409.8125 radius 1.0 1.0 // AT BOTTOM OF STEPS
		then
			0239: actor $ASUKA1_MAFIA11 run_to 880.9375 -409.0 // ON LANDING
			0004: $MAFIA_11_KILL_PLAYER_FLAG = 3 
		end
		if and
			0038:   $MAFIA_11_KILL_PLAYER_FLAG == 3
			00ED:   actor $ASUKA1_MAFIA11 #NULL 880.9375 -409.0 radius 1.0 1.0 // ON LANDING
		then
			0239: actor $ASUKA1_MAFIA11 run_to 880.9375 -406.0625 // ON LANDING
			0004: $MAFIA_11_KILL_PLAYER_FLAG = 4
		end
		if and
			0038:   $MAFIA_11_KILL_PLAYER_FLAG == 4
			00ED:   actor $ASUKA1_MAFIA11 #NULL 880.9375 -406.0625 radius 1.0 1.0 // ON LANDING
		then
			0239: actor $ASUKA1_MAFIA11 run_to 892.0625 -406.1875 // ON ROOF TOP OF STAIRS
			0004: $MAFIA_11_KILL_PLAYER_FLAG = 5
		end
		if and
			0038:   $MAFIA_11_KILL_PLAYER_FLAG == 5
			00ED:   actor $ASUKA1_MAFIA11 #NULL 892.0625 -406.1875 radius 1.0 1.0 // ON ROOF TOP OF STAIRS
		then
			0239: actor $ASUKA1_MAFIA11 run_to 892.1875 -421.1875  // IN MIDDLE OF ROOF
			01B2: give_actor $ASUKA1_MAFIA11 weapon WEAPONTYPE_UZI ammo 9999 
			0004: $MAFIA_11_KILL_PLAYER_FLAG = 6
		end
		if and 
			0038:   $MAFIA_11_KILL_PLAYER_FLAG == 6
			00F0:   actor $ASUKA1_MAFIA11 stopped #NULL 892.1875 -421.1875 radius 1.0 1.0 // IN MIDDLE OF ROOF
		then
			0411: set_actor $ASUKA1_MAFIA11 use_pednode_seek 1 
			0350: set_actor $ASUKA1_MAFIA11 maintain_position_when_attacked 1 
			01CA: actor $ASUKA1_MAFIA11 kill_player $PLAYER_CHAR 
			0004: $MAFIA_11_KILL_PLAYER_FLAG = 7
		end
	end
	...
	then
		...
		then
			...
			then
				...
				0239: actor $ASUKA1_MAFIA12 run_to 886.0 -414.0 // NEAR BOTTOM OF STEPS
				0004: $MAFIA_12_KILL_PLAYER_FLAG = 1 
			end
			if and
				0038:   $MAFIA_12_KILL_PLAYER_FLAG == 1 
				00ED:   actor $ASUKA1_MAFIA12 #NULL 886.0 -414.0 radius 1.0 1.0 // NEAR BOTTOM OF STEPS
			then
				0411: set_actor $ASUKA1_MAFIA12 use_pednode_seek 0 
				0239: actor $ASUKA1_MAFIA12 run_to 888.875 -409.8125 // AT BOTTOM OF STEPS
				0004: $MAFIA_12_KILL_PLAYER_FLAG = 2 
			end
			if and
				0038:   $MAFIA_12_KILL_PLAYER_FLAG == 2 
				00ED:   actor $ASUKA1_MAFIA12 #NULL 888.875 -409.8125 radius 1.0 1.0 // AT BOTTOM OF STEPS
			then
				0239: actor $ASUKA1_MAFIA12 run_to 880.9375 -409.0 // ON LANDING
				0004: $MAFIA_12_KILL_PLAYER_FLAG = 3 
			end
			if and
				0038:   $MAFIA_12_KILL_PLAYER_FLAG == 3
				00ED:   actor $ASUKA1_MAFIA12 #NULL 880.9375 -409.0 radius 1.0 1.0 // ON LANDING
			then
				0239: actor $ASUKA1_MAFIA12 run_to 880.9375 -406.0625 // ON LANDING
				0004: $MAFIA_12_KILL_PLAYER_FLAG = 4
			end
			if and
				0038:   $MAFIA_12_KILL_PLAYER_FLAG == 4
				00ED:   actor $ASUKA1_MAFIA12 #NULL 880.9375 -406.0625 radius 1.0 1.0 // ON LANDING
			then
				0239: actor $ASUKA1_MAFIA12 run_to 892.0625 -406.1875 // ON ROOF TOP OF STAIRS
				0004: $MAFIA_12_KILL_PLAYER_FLAG = 5
			end
			if and
				0038:   $MAFIA_12_KILL_PLAYER_FLAG == 5
				00ED:   actor $ASUKA1_MAFIA12 #NULL 892.0625 -406.1875 radius 1.0 1.0 // ON ROOF TOP OF STAIRS
			then
				0239: actor $ASUKA1_MAFIA12 run_to 899.25 -408.125 // AT FRONT OF ROOF
				01B2: give_actor $ASUKA1_MAFIA12 weapon WEAPONTYPE_UZI ammo 9999 
				0004: $MAFIA_12_KILL_PLAYER_FLAG = 6
			end
			if and 
				0038:   $MAFIA_12_KILL_PLAYER_FLAG == 6
				00F0:   actor $ASUKA1_MAFIA12 stopped #NULL 899.25 -408.125 radius 1.0 1.0 // AT FRONT OF ROOF
			then
				0411: set_actor $ASUKA1_MAFIA12 use_pednode_seek 1 
				0350: set_actor $ASUKA1_MAFIA12 maintain_position_when_attacked 1 
				01CA: actor $ASUKA1_MAFIA12 kill_player $PLAYER_CHAR 
				0004: $MAFIA_12_KILL_PLAYER_FLAG = 7
			end
		else
			if and
				0018:   $MAFIA_12_FLAG > 1 
			...
			then
				0411: set_actor $ASUKA1_MAFIA12 use_pednode_seek 1 
				0239: actor $ASUKA1_MAFIA12 run_to 882.75 -414.3125 
				0004: $MAFIA_12_KILL_PLAYER_FLAG = 1
			end
			if and
				0038:   $MAFIA_12_KILL_PLAYER_FLAG == 1 
				00F0:   actor $ASUKA1_MAFIA12 stopped #NULL 882.75 -414.3125 radius 1.0 1.0 
			then
				0411: set_actor $ASUKA1_MAFIA12 use_pednode_seek 1 
				0350: set_actor $ASUKA1_MAFIA12 maintain_position_when_attacked 1 
				01CA: actor $ASUKA1_MAFIA12 kill_player $PLAYER_CHAR 
	...
	then
		...
		then
			...
			0239: actor $ASUKA1_MAFIA13 run_to 886.0 -414.0 // NEAR BOTTOM OF STEPS
			0004: $MAFIA_13_KILL_PLAYER_FLAG = 1 
		end
		if and
			0038:   $MAFIA_13_KILL_PLAYER_FLAG == 1 
			00ED:   actor $ASUKA1_MAFIA13 #NULL 886.0 -414.0 radius 1.0 1.0 // NEAR BOTTOM OF STEPS
		then
			0411: set_actor $ASUKA1_MAFIA13 use_pednode_seek 0 
			0239: actor $ASUKA1_MAFIA13 run_to 888.875 -409.8125 // AT BOTTOM OF STEPS
			0004: $MAFIA_13_KILL_PLAYER_FLAG = 2 
		end
		if and
			0038:   $MAFIA_13_KILL_PLAYER_FLAG == 2 
			00ED:   actor $ASUKA1_MAFIA13 #NULL 888.875 -409.8125 radius 1.0 1.0 // AT BOTTOM OF STEPS
		then
			0239: actor $ASUKA1_MAFIA13 run_to 880.9375 -409.0 // ON LANDING
			0004: $MAFIA_13_KILL_PLAYER_FLAG = 3 
		end
		if and
			0038:   $MAFIA_13_KILL_PLAYER_FLAG == 3
			00ED:   actor $ASUKA1_MAFIA13 #NULL 880.9375 -409.0 radius 1.0 1.0 // ON LANDING
		then
			0239: actor $ASUKA1_MAFIA13 run_to 880.9375 -406.0625 // ON LANDING
			0004: $MAFIA_13_KILL_PLAYER_FLAG = 4
		end
		if and
			0038:   $MAFIA_13_KILL_PLAYER_FLAG == 4
			00ED:   actor $ASUKA1_MAFIA13 #NULL 880.9375 -406.0625 radius 1.0 1.0 // ON LANDING
		then
			0239: actor $ASUKA1_MAFIA13 run_to 892.0625 -406.1875 // ON ROOF TOP OF STAIRS
			0004: $MAFIA_13_KILL_PLAYER_FLAG = 5
		end
		if and
			0038:   $MAFIA_13_KILL_PLAYER_FLAG == 5
			00ED:   actor $ASUKA1_MAFIA13 #NULL 892.0625 -406.1875 radius 1.0 1.0 // ON ROOF TOP OF STAIRS
		then
			0239: actor $ASUKA1_MAFIA13 run_to 892.1875 -421.1875  // IN MIDDLE OF ROOF
			0004: $MAFIA_13_KILL_PLAYER_FLAG = 6
		end
		if
			0038:   $MAFIA_13_KILL_PLAYER_FLAG == 6
		then
			if
				0057:   is_player_in_area_3d $PLAYER_CHAR coords 890.75 -433.6875 23.0 to 900.75 -403.75 46.0 sphere 0 //CLUB ROOF
			then
				0239: actor $ASUKA1_MAFIA13 run_to 893.25 -425.0 // ABOVE SMALL ROOF BETWEEN BILLBOARD
			else
				0239: actor $ASUKA1_MAFIA13 run_to 892.125 -429.0625 // ABOVE SMALL ROOF
			end
			0004: $MAFIA_13_KILL_PLAYER_FLAG = 7
		end
		if and
			0038:   $MAFIA_13_KILL_PLAYER_FLAG == 7
			00ED:   actor $ASUKA1_MAFIA13 #NULL 892.1875 -421.1875 radius 1.0 1.0 // IN MIDDLE OF ROOF
		then
			if
				0057:   is_player_in_area_3d $PLAYER_CHAR coords 890.75 -433.6875 23.0 to 900.75 -403.75 46.0 sphere 0 //CLUB ROOF
			then
				0239: actor $ASUKA1_MAFIA13 run_to 893.25 -425.0 // ABOVE SMALL ROOF BETWEEN BILLBOARDS
				if
					00F0:   actor $ASUKA1_MAFIA13 stopped #NULL 893.25 -425.0 radius 1.0 1.0 // ABOVE SMALL ROOF
				then
					0411: set_actor $ASUKA1_MAFIA13 use_pednode_seek 1 
					0350: set_actor $ASUKA1_MAFIA13 maintain_position_when_attacked 1 
					01CA: actor $ASUKA1_MAFIA13 kill_player $PLAYER_CHAR 
					0004: $MAFIA_13_KILL_PLAYER_FLAG = 8
				end
			else
				0239: actor $ASUKA1_MAFIA13 run_to 892.125 -429.0625 // ABOVE SMALL ROOF
				if
					00F0:   actor $ASUKA1_MAFIA13 stopped #NULL 892.125 -429.0625 radius 1.0 1.0 // ABOVE SMALL ROOF
				then
					0411: set_actor $ASUKA1_MAFIA13 use_pednode_seek 1 
					0350: set_actor $ASUKA1_MAFIA13 maintain_position_when_attacked 1 
					01CA: actor $ASUKA1_MAFIA13 kill_player $PLAYER_CHAR 
	...
	if or
		0038:   $MAFIA_10_KILL_PLAYER_FLAG == 6 
		0038:   $MAFIA_10_FLAG == 4 
	then
		if or
			0038:   $MAFIA_11_KILL_PLAYER_FLAG == 7 
			0038:   $MAFIA_11_FLAG == 4 
		then
			if or
				0038:   $MAFIA_12_KILL_PLAYER_FLAG == 7 
				0038:   $MAFIA_12_FLAG == 4
			then
				if or
					0038:   $MAFIA_13_KILL_PLAYER_FLAG == 8 
