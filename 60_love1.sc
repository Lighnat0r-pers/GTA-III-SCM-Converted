...
// Random number stuff to generate OGG position
0209: $OGG_POSITION = random_int_in_ranges 2 6 

if
	0038:   $OGG_POSITION == 2 
then
	009A: $OJG_LOVE1 = create_char PEDTYPE_SPECIAL model #SPECIAL02 at 25.1875 -340.25 15.0625 
	01ED: clear_actor $OJG_LOVE1 threat_search 
	01BE: set_actor $OJG_LOVE1 to_look_at_spot 57.0 -314.0 -100.0 
	009F: char_set_idle $OJG_LOVE1 
end
if
	0038:   $OGG_POSITION == 3
then
	009A: $OJG_LOVE1 = create_char PEDTYPE_SPECIAL model #SPECIAL02 at 26.25 -339.6875 15.0625 
	01ED: clear_actor $OJG_LOVE1 threat_search 
	01BE: set_actor $OJG_LOVE1 to_look_at_spot 29.0 -339.0 -100.0 
	009F: char_set_idle $OJG_LOVE1 
end
if
	0038:   $OGG_POSITION == 4
then
	009A: $OJG_LOVE1 = create_char PEDTYPE_SPECIAL model #SPECIAL02 at 25.5 -350.375 15.0625 
	01ED: clear_actor $OJG_LOVE1 threat_search 
	01BE: set_actor $OJG_LOVE1 to_look_at_spot 29.0 -350.0 -100.0 
	009F: char_set_idle $OJG_LOVE1 
end
if
	0038:   $OGG_POSITION == 5
then
	009A: $OJG_LOVE1 = create_char PEDTYPE_SPECIAL model #SPECIAL02 at 47.0 -386.0 15.0625 
	01ED: clear_actor $OJG_LOVE1 threat_search 
	01BE: set_actor $OJG_LOVE1 to_look_at_spot 47.0 -381.0 16.0 
	009F: char_set_idle $OJG_LOVE1 
end
